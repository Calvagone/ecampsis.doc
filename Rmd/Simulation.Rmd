...
e-Campsis offers a very powerful interface to overlay external data on the simulated data. This feature, reserved to pro users only, can be useful to:
...
- more generally, add any ggplot layer to annotate your plot (e.g. add a label, some text, a line, a cross bar, etc.)
